    ...
    <div style="margin-bottom:10px;">
        ...
        <?php if (!empty($simulation_active)): ?>
            <div style="font-size:12px; color:#aa741f; margin-top:3px;">
                ※AI3連対率は検証条件に合わせ、基礎率の今回コースを「枠番=コース」として計算（仮想進入補正は未適用）
            </div>
        <?php endif; ?>
    </div>
            ...
            <table style="width:100%; min-width:760px; border-collapse:collapse;">
                <thead>
                    <tr style="background-color:#1e293b;">
                        ...
                        <?php for ($lane = 1; $lane <= 6; $lane++): ?>
                            <?php $c = $lane_colors[$lane] ?? $lane_colors[1]; ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <?php for ($lane = 1; $lane <= 6; $lane++): ?>
                            <?php $rate = $aiTrioBoats[$lane]['base_rate'] ?? null; ?>
