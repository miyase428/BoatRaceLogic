{
    "KRY": ["exhibition_time", "lap_time", "around_time"],        # 桐生：バランス＋ターン
    "TDA": ["exhibition_time", "lap_time", "around_time"],        # 戸田：ターン水面
    "EDG": ["exhibition_time", "lap_time", "around_time"],        # 江戸川：荒水面→ターン寄り
    "HWJ": ["exhibition_time", "lap_time", "around_time"],        # 平和島：ターン寄り
    "TMG": ["exhibition_time", "lap_time", "straight_time"],      # 多摩川：伸び寄り
    "HMN": ["exhibition_time", "lap_time", "straight_time"],      # 浜名湖：伸び寄り
    "GMG": ["exhibition_time", "lap_time", "straight_time"],      # 蒲郡：伸び寄り
    "TKN": ["exhibition_time", "lap_time", "straight_time"],      # 常滑：伸び寄り
    "TSU": ["exhibition_time", "lap_time", "around_time"],        # 津：ターン寄り
    ...
    "FKO": ["exhibition_time", "lap_time", "around_time"],        # 福岡：ターン寄り
    "KRT": ["exhibition_time", "lap_time", "around_time"],        # 唐津：ターン寄り
    "OMR": ["exhibition_time", "lap_time", "straight_time"]      # 大村：伸び寄り
}
